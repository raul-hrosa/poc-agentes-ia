...
- Name: T-004-auth.spec.ts >> T-004 — Auth API >> POST /auth/confirm-email >> sem ?token no query → 401 "Token ausente"
- Location: tests/e2e/T-004-auth.spec.ts:314:9
...
Call log:
  - → POST http://localhost:3001/api/v1/auth/confirm-email
