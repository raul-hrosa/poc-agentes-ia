...
- Name: T-004-auth.spec.ts >> T-004 — Auth API >> POST /auth/reset-password >> token inválido + senha válida → 400 "Token inválido ou expirado"
- Location: tests/e2e/T-004-auth.spec.ts:287:9
