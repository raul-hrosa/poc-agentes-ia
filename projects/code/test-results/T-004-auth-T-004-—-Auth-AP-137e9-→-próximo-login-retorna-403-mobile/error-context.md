...
- Name: T-004-auth.spec.ts >> T-004 — Auth API >> POST /auth/login >> 5 tentativas com senha errada bloqueiam a conta → próximo login retorna 403
- Location: tests/e2e/T-004-auth.spec.ts:120:9
