...
- Name: T-004-auth.spec.ts >> T-004 — Auth API >> POST /auth/forgot-password >> e-mail desconhecido → 200 com mensagem genérica (anti-enumeração)
- Location: tests/e2e/T-004-auth.spec.ts:241:9
