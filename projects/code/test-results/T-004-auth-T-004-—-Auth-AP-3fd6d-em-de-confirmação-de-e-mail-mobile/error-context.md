...
- Name: T-004-auth.spec.ts >> T-004 — Auth API >> POST /auth/register >> body válido → 201 com mensagem de confirmação de e-mail
- Location: tests/e2e/T-004-auth.spec.ts:25:9
