...
- Name: T-004-auth.spec.ts >> T-004 — Auth API >> POST /auth/login >> senha incorreta em conta registrada → 401 "Credenciais inválidas"
- Location: tests/e2e/T-004-auth.spec.ts:96:9
