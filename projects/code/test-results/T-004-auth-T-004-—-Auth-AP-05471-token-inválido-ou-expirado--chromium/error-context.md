...
- Name: T-004-auth.spec.ts >> T-004 — Auth API >> POST /auth/refresh >> cookie com token desconhecido → 401 "Refresh token inválido ou expirado"
- Location: tests/e2e/T-004-auth.spec.ts:173:9
...
Call log:
  - → POST http://localhost:3001/api/v1/auth/refresh
    ...
    - Cookie: refresh_token=tokeninvalidoqualquer
