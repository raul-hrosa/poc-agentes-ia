...
- Name: T-004-auth.spec.ts >> T-004 — Auth API >> POST /auth/forgot-password >> e-mail cadastrado → 200 com mesma mensagem genérica
- Location: tests/e2e/T-004-auth.spec.ts:250:9
