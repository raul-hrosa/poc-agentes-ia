  ...
  return (
    <div className="relative">
      <button
        ...
        className="flex items-center gap-2 rounded-lg px-2 py-1 text-sm hover:bg-muted focus:outline-none focus:ring-2 focus:ring-ring min-h-[44px]"
      ...
      {isOpen && (
        <>
          ...
          <div
            role="menu"
            className="absolute right-0 z-20 mt-1 w-48 origin-top-right rounded-md bg-background shadow-lg ring-1 ring-border"
          >
            <div className="py-1">
